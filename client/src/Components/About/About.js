    ...
    return (
        <div className="About">
            ...
            <Typography variant="body1" mx={5} mb={3}>
                ...
                simply want a reliable source for finding new products to use. My skincare journey first started when my friend and I were having a spa night and doing face masks. I remember watching YouTube videos of some of her favorite skincare channels as she was telling me about her own skincare journey. She convinced me to start on my own journey, but it wasn't always easy. My friend and I struggled sometimes, buying products that were actually damaging our skin or just weren't targetting the specific issues we were having respectively.
            </Typography>
            <Typography variant="body1" mx={5} mb={10}>
                I personally know how difficult it can be to start your skincare journey. Even with the help of my friend, I still felt lost in all the products out there from time to time. But I am finally at a happy place with my skin! And I want to help others feel the same way in their own skin. The Skincare Place is a love letter to my friend, and I hope that my passion extends to y'all to feel welcomed and loved.
            </Typography>
            <Divider>
